...
### Basic Functionality
When the main `App` component mounts it sends a request to the server which gets the content from [YCombintor](https://news.ycombinator.com) and parses the first 30 posts. _See server/util/crawler.js_ 
